...
const Services = () => {
  return (
    <div className="w-full h-[50vh] flex">
      <div className="w-[50%] h-full flex flex-col  justify-center justify-center gap-11">
      ...
      <div className="w-[50%] h-full flex gap-2 items-center overflow-x-scroll">
        ...
        <div className="w-[350px] h-[380px] border-2 rounded-lg flex flex-col gap-2">
            <div className="w-full h-[70%] flex item-center justify-center">
                <img src={destination} className="w-20 h-20 " alt="" />
            </div>
        ...
        <div className="w-[350px] h-[380px] border-2 rounded-lg flex flex-col gap-2">
            <div className="w-full h-[70%] flex flex-col item-center justify-center">
            <img src={destination} className="w-20 h-20 " alt="" />
            </div>
